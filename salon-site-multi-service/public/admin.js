...
function renderBookingsTable() {
  ...
  bookings
    ...
    .forEach(b => {
      ...
      const servicesLabel = Array.isArray(b.services) ? b.services.join(', ') : (b.services || '');
...
function renderCalendar() {
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    cell.addEventListener('click', () => showBookingsForDate(dateStr));
    calendarGrid.appendChild(cell);
  }
}
  ...
  items
    ...
    .forEach(b => {
      ...
      li.innerHTML = `
        ...
        <span class="muted small">${servicesLabel}${b.staffName ? ' • ' + b.staffName : ''}</span>
      `;
